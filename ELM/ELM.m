function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY,TV] = ELM(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
